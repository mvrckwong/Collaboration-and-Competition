...
class Actor_Critic():
    """ Initialize all methods. (Actor-Critic Method)
    Containing all the Models required in DDPG Agent.
    Local and Target Actor / Local and Target Critic
    """
    def __init__(self, n_agents, state_size, action_size, seed=1):
        """
        Params
        ======
