...
1. Clone this reposity, change the directory manually.
...
4. Relocate and Extract the tennis executable file. To train the agent, open command line then type in `python train.py`.
